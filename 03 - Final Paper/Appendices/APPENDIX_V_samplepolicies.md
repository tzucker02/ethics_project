...
### 3. Encouraging Generative AI Use with Attribution (ANY‑AI‑UA)  
**Source:** Cornell University – Academic Integrity (2025) – <https://teaching.cornell.edu/generative-artificial-intelligence/ai-academic-integrity>
...
### 4. Permitting Generative AI Use on an Assignment‑by‑Assignment Basis (AS)  
**Source:** Cornell University – Academic Integrity (2025) – <https://teaching.cornell.edu/generative-artificial-intelligence/ai-course-policy-icons>
...
> As generative AI technologies evolve, class policies with respect to the use of generative AI tools may be shaped by in‑class discussions regarding the fair use of AI and its implications on careers in this field.  
